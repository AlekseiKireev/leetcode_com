...
Привет! На собесе дали https://leetcode.com/problems/line-reflection, но с изменениями: там дублировались точки, и это надо было учитывать, в то время как на литкоде все можно слить в один хеш-сет.
