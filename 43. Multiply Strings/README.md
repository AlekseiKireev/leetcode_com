...
<br>
             ...
             -----
              1368
            + 9120 [10488] -- заметим, что смещение влево (количество нулей справа) происходит на индекс умножаемого числа num1
            +45600
             -----
             56088    == MultiplyStrings -- заметим, что можно использовать в качестве буффера данный аргумент
             _____
             43210
_____
