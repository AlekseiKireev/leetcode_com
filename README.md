...
- [560. Subarray Sum Equals K](https://github.com/SkosMartren/leetcode_com/tree/main/560.%20Subarray%20Sum%20Equals%20K) -- Total number of subarrays whose sum = k. 1 passes: PrefixSum += num; Ans += PrefixToCount[PrefixSum - RequiredAffix]; ++PrefixToCount[PrefixSum]; + u_m : Prefix -> Count. 
