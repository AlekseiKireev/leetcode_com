...
Т.е. STACK должен соответствовать заявленным значениям open и closed 
___

Инвариант свойственный ПСП: 

Положим, в ПСП N открывающих скобок, тогда при проходе слева-направа для пройденного префикса выполнятеся инвариант: 
