...
Если foundBefore = true для некоторого узла V, это значит, что текущий узел не может быть ответом, так как не является общим предком [родителем] p и q.  
Отметии, что каждый узел считается своим предком, ввиду чего в бамбуке вида: $... --> p ... --> q --> ...$ ответом будет $p$.
