...
Рассмотирим один проход по instructions как способ задания вектора на двумерное плоскости. При это, набор "L" и "R" в конечном итоге будет задавать поворот вектора. Изначально, по услвоию, вектор направлен на север, в положительном направлении оси OX. Рассмторим случаи: 
- 
