...
отсюда видно, что если робот смотрел в конце каждого из 4 циклов в разные стороны, то он вернется в результате в исходную точку. Гарантируется, что робот будет смотреть в каждую точку, если после первого цикла он не смотрит на север. Если смотрим на запад / восток, то будет просто поварачиваться по противочасовой/часовое стрелке на 90 градусов.

Если смотрит на юг, то просто вернеться в исходную точку за два цикла, пройдя путь обратно, а не 4.

Также возможно что за один цикл он вернется в исходную точку
